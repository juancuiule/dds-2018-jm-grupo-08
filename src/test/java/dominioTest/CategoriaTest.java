...
public class CategoriaTest {
    ...
    public void correspondeCategoria_DadoUnConsumoQueCorrespondeAlaCategoria_true() {
        assertEquals("Falla - el consumo deberia corresponder a esta categoria",categoriaDePrueba.correspondeCategoria(800d),true);
    }
    
    @Test
    public void correspondeCategoria_DadoUnConsumoQueNoCorrespondeAlaCategoria_false() {
        assertEquals("Falla - el consumo deberia corresponder a esta categoria",categoriaDePrueba.correspondeCategoria(1800d),false);
    }
