...
public class DeserializersTest {
    ...
    public void generarReaders() {
        try {
            ...
            readerClienteSinDispositivos = new JsonReader(new FileReader("src/test/resources/clienteSinDispositivos.json"));
    ...
    // centrandonos en aquellos cuya deserializacion no esta estandarizada por la libreria GSON
    // Estos son:
