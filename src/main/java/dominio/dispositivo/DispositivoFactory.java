...
import dominio.dispositivoBase.RepositorioDispositivoBase;

public class DispositivoFactory {
	
	public Dispositivo dispositivoFactory(String nombreDelDispositivo) {
		
		Optional<DispositivoBase> dispositivo = RepositorioDispositivoBase.getInstance().buscarDispositivo(nombreDelDispositivo);
